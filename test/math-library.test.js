/*
    This file contains unit tests for MathLibrary model.
    To run locally, make sure you installed modules:
    - mocha
    - chai 
    Use command 'npm install' to import these.
    To run unit testing, enter 'npm test' or 'mocha' in integrated terminal.
*/
